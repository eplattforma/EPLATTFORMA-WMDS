...
def invoice_detail(invoice_no):
    ...
    # 🔧 FIXED: Use item_completed instead of end_time
    tracking_map = {
        t.item_code: format_local_time(localize_datetime(t.item_completed), '%H:%M:%S') 
        for t in tracking_records if t.item_completed
    }
