...
--
-- Name: sync_invoice_on_stop_change(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.sync_invoice_on_stop_change() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- If shipment_id changed, update all active invoices linked to this stop
    IF TG_OP = 'UPDATE' AND OLD.shipment_id IS DISTINCT FROM NEW.shipment_id THEN
        UPDATE invoices 
        SET route_id = NEW.shipment_id 
        WHERE stop_id = NEW.route_stop_id;
    END IF;
...
ALTER FUNCTION public.sync_invoice_on_stop_change() OWNER TO neondb_owner;

--
-- Name: sync_invoice_route_cache(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.sync_invoice_route_cache() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_shipment_id INTEGER;
BEGIN
    -- Handle DELETE: clear cache on the invoice
    IF TG_OP = 'DELETE' THEN
        -- Only clear if this was the active assignment
    ...
    IF TG_OP = 'INSERT' OR TG_OP = 'UPDATE' THEN
        -- If becoming active, set the cache
        IF NEW.is_active = TRUE THEN
            SELECT shipment_id INTO v_shipment_id 
            FROM route_stop 
            WHERE route_stop_id = NEW.route_stop_id;
            
            UPDATE invoices 
            SET route_id = v_shipment_id, stop_id = NEW.route_stop_id 
            WHERE invoice_no = NEW.invoice_no;
        -- If becoming inactive (was active), clear the cache
...
ALTER FUNCTION public.sync_invoice_route_cache() OWNER TO neondb_owner;
...
--
-- Name: cod_invoice_allocations; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.cod_invoice_allocations (
    id integer NOT NULL,
...
ALTER TABLE public.cod_invoice_allocations OWNER TO neondb_owner;

--
-- Name: cod_invoice_allocations_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.cod_invoice_allocations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.cod_invoice_allocations_id_seq OWNER TO neondb_owner;

--
-- Name: cod_invoice_allocations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.cod_invoice_allocations_id_seq OWNED BY public.cod_invoice_allocations.id;
...
CREATE TABLE public.delivery_discrepancies (
    ...
    actual_barcode text,
    warehouse_checked_by character varying(64),
    warehouse_checked_at timestamp without time zone,
    warehouse_result character varying(30),
    warehouse_note text,
    credit_note_required boolean DEFAULT false,
    credit_note_no character varying(50),
    credit_note_amount numeric(12,2),
    credit_note_created_at timestamp without time zone,
...
--
-- Name: invoice_payment_expectations; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.invoice_payment_expectations (
    invoice_no character varying(50) NOT NULL,
    expected_payment_method character varying(20) NOT NULL,
    is_cod boolean NOT NULL,
    expected_amount numeric(12,2),
    customer_code_365 character varying(50),
    terms_code character varying(50),
    due_days integer,
    captured_at timestamp without time zone NOT NULL
);


ALTER TABLE public.invoice_payment_expectations OWNER TO neondb_owner;
...
CREATE TABLE public.invoice_post_delivery_cases (
    ...
    credit_note_no character varying(64),
    credit_note_issued_at timestamp without time zone,
    credit_note_issued_by character varying(64)
);
...
--
-- Name: route_return_handover; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.route_return_handover (
    id integer NOT NULL,
    route_id integer NOT NULL,
    route_stop_id integer,
    invoice_no character varying(50) NOT NULL,
...
ALTER TABLE public.route_return_handover OWNER TO neondb_owner;

--
-- Name: route_return_handover_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.route_return_handover_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.route_return_handover_id_seq OWNER TO neondb_owner;

--
-- Name: route_return_handover_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.route_return_handover_id_seq OWNED BY public.route_return_handover.id;
...
--
-- Name: v_route_stop_invoice_active; Type: VIEW; Schema: public; Owner: neondb_owner
--

CREATE VIEW public.v_route_stop_invoice_active AS
 SELECT route_stop_invoice_id,
    route_stop_id,
    invoice_no,
    status,
    weight_kg,
    ...
    effective_to,
    changed_by
   FROM public.route_stop_invoice
  WHERE (is_active = true);


ALTER VIEW public.v_route_stop_invoice_active OWNER TO neondb_owner;

--
-- Name: v_shipment_orders; Type: VIEW; Schema: public; Owner: neondb_owner
--

CREATE VIEW public.v_shipment_orders AS
 SELECT rs.shipment_id,
    rsi.invoice_no
   FROM (public.route_stop rs
     JOIN public.route_stop_invoice rsi ON ((rsi.route_stop_id = rs.route_stop_id)))
  WHERE (rsi.is_active = true);


ALTER VIEW public.v_shipment_orders OWNER TO neondb_owner;
...
--
-- Name: cod_invoice_allocations id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.cod_invoice_allocations ALTER COLUMN id SET DEFAULT nextval('public.cod_invoice_allocations_id_seq'::regclass);
...
--
-- Name: route_return_handover id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover ALTER COLUMN id SET DEFAULT nextval('public.route_return_handover_id_seq'::regclass);
...
--
-- Name: cod_invoice_allocations cod_invoice_allocations_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.cod_invoice_allocations
    ADD CONSTRAINT cod_invoice_allocations_pkey PRIMARY KEY (id);
...
--
-- Name: invoice_payment_expectations invoice_payment_expectations_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.invoice_payment_expectations
    ADD CONSTRAINT invoice_payment_expectations_pkey PRIMARY KEY (invoice_no);
...
--
-- Name: route_return_handover route_return_handover_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_pkey PRIMARY KEY (id);
...
--
-- Name: ix_cod_alloc_invoice; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX ix_cod_alloc_invoice ON public.cod_invoice_allocations USING btree (invoice_no);


--
-- Name: ix_cod_alloc_pending; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX ix_cod_alloc_pending ON public.cod_invoice_allocations USING btree (is_pending) WHERE (is_pending = true);


--
-- Name: ix_cod_alloc_route; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX ix_cod_alloc_route ON public.cod_invoice_allocations USING btree (route_id);
...
--
-- Name: ix_dd_invoice_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX ix_dd_invoice_status ON public.delivery_discrepancies USING btree (invoice_no, status, is_validated, is_resolved);
...
--
-- Name: ix_return_handover_driver_pending; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: ix_rsi_active_status; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: ix_rsi_active_stop; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: uq_rsi_active_invoice; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: ux_return_handover_route_invoice; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: route_stop trg_sync_invoice_on_stop_change; Type: TRIGGER; Schema: public; Owner: neondb_owner
--

CREATE TRIGGER trg_sync_invoice_on_stop_change AFTER UPDATE ON public.route_stop FOR EACH ROW EXECUTE FUNCTION public.sync_invoice_on_stop_change();


--
-- Name: route_stop_invoice trg_sync_invoice_route_cache; Type: TRIGGER; Schema: public; Owner: neondb_owner
--

CREATE TRIGGER trg_sync_invoice_route_cache AFTER INSERT OR DELETE OR UPDATE ON public.route_stop_invoice FOR EACH ROW EXECUTE FUNCTION public.sync_invoice_route_cache();
...
--
-- Name: cod_invoice_allocations cod_invoice_allocations_cod_receipt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.cod_invoice_allocations
    ADD CONSTRAINT cod_invoice_allocations_cod_receipt_id_fkey FOREIGN KEY (cod_receipt_id) REFERENCES public.cod_receipts(id) ON DELETE CASCADE;


--
-- Name: cod_invoice_allocations cod_invoice_allocations_invoice_no_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.cod_invoice_allocations
    ADD CONSTRAINT cod_invoice_allocations_invoice_no_fkey FOREIGN KEY (invoice_no) REFERENCES public.invoices(invoice_no);


--
-- Name: cod_invoice_allocations cod_invoice_allocations_route_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.cod_invoice_allocations
    ADD CONSTRAINT cod_invoice_allocations_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.shipments(id);
...
--
-- Name: delivery_discrepancies delivery_discrepancies_warehouse_checked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.delivery_discrepancies
    ADD CONSTRAINT delivery_discrepancies_warehouse_checked_by_fkey FOREIGN KEY (warehouse_checked_by) REFERENCES public.users(username);
...
--
-- Name: invoice_payment_expectations invoice_payment_expectations_invoice_no_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.invoice_payment_expectations
    ADD CONSTRAINT invoice_payment_expectations_invoice_no_fkey FOREIGN KEY (invoice_no) REFERENCES public.invoices(invoice_no) ON DELETE CASCADE;
...
--
-- Name: route_return_handover route_return_handover_driver_username_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_driver_username_fkey FOREIGN KEY (driver_username) REFERENCES public.users(username);


--
-- Name: route_return_handover route_return_handover_invoice_no_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_invoice_no_fkey FOREIGN KEY (invoice_no) REFERENCES public.invoices(invoice_no);


--
-- Name: route_return_handover route_return_handover_received_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_received_by_fkey FOREIGN KEY (received_by) REFERENCES public.users(username);


--
-- Name: route_return_handover route_return_handover_route_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.shipments(id);


--
-- Name: route_return_handover route_return_handover_route_stop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_return_handover
    ADD CONSTRAINT route_return_handover_route_stop_id_fkey FOREIGN KEY (route_stop_id) REFERENCES public.route_stop(route_stop_id);
...
--
-- Name: route_stop_invoice route_stop_invoice_manifest_locked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.route_stop_invoice
    ADD CONSTRAINT route_stop_invoice_manifest_locked_by_fkey FOREIGN KEY (manifest_locked_by) REFERENCES public.users(username);
