...
- **Core Features**:
    ...
    - **Review Ordering (4-State)**: An enhanced review page for managing customer orders with computed states (follow_up, waiting, ordered, done). Within each state, rows with carts sort to the top. Integrated with customer profiles and communication tools.
