...
- **Core Features**:
    ...
    - **Offer Intelligence**: Imports customer-specific pricing, enriches it with cost/margin/sales data, and provides UI for managing and analyzing customer offers.
