...
class SkuForecastProfile(db.Model):
    ...
    forecast_method = db.Column(db.String(64), nullable=False, default='ZERO')
    trend_flag = db.Column(db.String(10), nullable=False, default='flat')
    trend_pct = db.Column(db.Numeric(12, 6), nullable=True)
    seasonality_source = db.Column(db.String(64), nullable=False, default='none')
    ...
    seed_source = db.Column(db.String(64), nullable=True)
    analogue_item_code = db.Column(db.String(64), nullable=True)
    analogue_level = db.Column(db.String(64), nullable=True)
    ...
    baseline_source = db.Column(db.String(64), nullable=True)
